...
git clone "https://oauth2:$ACCESS_TOKEN@gitlab.com/group/project-name-example-99999.git" || (cd dspro && git pull)
cd dspro
...
NOTEBOOK_PATH="dspro/4_modeling/training_models_example_path.ipynb"
OUTPUT_NAME="temp_executed_notebook"
OUTPUT_PATH="dspro/4_modeling"
