...
DEFAULT_DOWNLOAD_LINK = None

# If this is in the file name, should be set
FILE_NAME_PART = "data"
...
# If a map_occurrences_to_files function is given, the files will be mapped and the files will automatically be pre-downloaded.
